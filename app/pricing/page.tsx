    ...
    <div style={{ minHeight: '100vh', background: '#000000', color: '#FFFFFF', fontFamily: 'JetBrains Mono, monospace' }}>
      ...
      <section style={{ padding: '0 1.5rem 8rem', position: 'relative', zIndex: 1 }}>
        <div style={{
          ...
          {/* Crossheads at corners of the whole grid */}
          ...
          <div className="hover-card" style={{ padding: '3rem', borderRight: '1px solid rgba(255,255,255,0.12)' }}>
            ...
            <p style={{ color: '#666666', fontSize: '0.8125rem', marginBottom: '2.5rem', lineHeight: 1.6 }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 3rem', display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              {FREE_FEATURES.map(f => (
                <li key={f} style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start', fontSize: '0.8125rem', color: '#A1A1AA' }}>
                  <span style={{ color: '#FFFFFF', flexShrink: 0, marginTop: '0.1em' }}>✓</span>
                  {f}
                </li>
              ))}
            </ul>
          ...
          <div className="hover-card" style={{ padding: '3rem', background: '#080808', position: 'relative' }}>
            ...
            <div style={{
              ...
              padding: '0.2rem 0.6rem', border: '1px solid #FFFFFF',
            ...
            <p style={{ color: '#888888', fontSize: '0.8125rem', marginBottom: '2.5rem', lineHeight: 1.6 }}>
      ...
      <section style={{ padding: '0 1.5rem 8rem' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#555555', marginBottom: '2rem' }}>
            Full comparison
          </div>
      ...
      <section style={{ padding: '0 1.5rem 10rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', position: 'relative' }}>
          <div style={{
            border: '1px solid rgba(255,255,255,0.1)', padding: '4rem 3rem', position: 'relative',
          }}>
            <Crosshead style={{ top: '-7.5px', left: '-7.5px' }} />
            <Crosshead style={{ top: '-7.5px', right: '-7.5px' }} />
            <Crosshead style={{ bottom: '-7.5px', left: '-7.5px' }} />
            ...
            <h2 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: '1rem' }}>
              Start scanning in 30 seconds.
            </h2>
            <p style={{ color: '#666666', fontSize: '0.875rem', lineHeight: 1.7, marginBottom: '2.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <code style={{
                ...
                border: '1px solid rgba(255,255,255,0.15)',
                color: '#666666', fontSize: '0.8125rem',
              }}>
